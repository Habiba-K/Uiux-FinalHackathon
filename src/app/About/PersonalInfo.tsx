  ...
  return (
    <div>
      ...
      <div className="container h-auto mx-auto w-full  lg:max-w-[1440px] md:h-[150px]">
        ...
        <div className="text-[#E74040] ml-32 ">
            Problems trying
        </div>
        <div className="grid grid-cols-1  lg:grid-cols-2 gap-2 p-10 place-items-center place-content-center h-[96px]">
          {/* Side 1 */}
          <div className="text-[#252B42] font-bold text-xl w-[394px] place-items-center">
            Met minim Mollie non desert Alamo est sit cliquey dolor do met sent.
            </div>

          {/* Side 2 */}
          <div className="w-[394px] text-[#737373] text-sm">
